#!/usr/bin/env python3
"""
Test script to manually trigger scraping for upload ID ad18b573-e776-4f54-ba65-288dfbdedd3a
This will test the auto-triggering in real-time
"""
import sys
import os
...
def main():
    print("🚀 Testing real-time scraping for upload ID ad18b573-e776-4f54-ba65-288dfbdedd3a...")
