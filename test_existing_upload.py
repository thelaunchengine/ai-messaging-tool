#!/usr/bin/env python3
"""
Test script to manually trigger contact form submission for existing upload
"""
import sys
import os
...
def main():
    print("🚀 Testing contact form submission for existing upload...")
    
    # Upload ID to test
    upload_id = 'd1240c6c-982e-4707-9128-b76ce757a8a4'
