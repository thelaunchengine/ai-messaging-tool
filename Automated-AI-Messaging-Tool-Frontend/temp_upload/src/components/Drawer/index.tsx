...
const userMenuItems = [
  ...
  { text: 'File Upload', icon: <UploadIcon />, path: '/file-upload' },
  { text: 'Processing Status', icon: <AssessmentIcon />, path: '/processing-status' },
...
const adminMenuItems = [
  ...
  { text: 'Scraping', icon: <AssessmentIcon />, path: '/admin/scraping' },
  { text: 'Content', icon: <ContentPaste />, path: '/admin/content' },
