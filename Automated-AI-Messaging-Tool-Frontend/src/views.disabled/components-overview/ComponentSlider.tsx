...
// assets
import { VolumeHigh, VolumeMute } from '@wandersonalwes/iconsax-react';
...
export default function ComponentSlider() {
  ...
  <VolumeMute style={{ color: volume <= 25 ? 'inherit' : 'text.secondary' }} />
  <Slider aria-label="Volume" value={volume} onChange={handleVolumeChange} />
  <VolumeHigh style={{ color: volume > 25 ? 'inherit' : 'text.secondary' }} />
</Stack>`;
