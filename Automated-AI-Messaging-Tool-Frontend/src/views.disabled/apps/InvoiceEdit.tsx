                    ...
                    <Grid size={{ xs: 12, sm: 8 }}>
                      <Stack sx={{ gap: 2 }}>
                        ...
                        <Stack sx={{ width: 1 }}>
                          ...
                          <Typography sx={{ color: 'secondary.main' }}>{values?.cashierInfo?.address}</Typography>
                          <Typography sx={{ color: 'secondary.main' }}>{values?.cashierInfo?.phone}</Typography>
                          <Typography sx={{ color: 'secondary.main' }}>{values?.cashierInfo?.email}</Typography>
                        </Stack>
                      </Stack>
                    </Grid>
                    ...
                    <Grid size={{ xs: 12, sm: 8 }}>
                      <Stack sx={{ gap: 2 }}>
                        ...
                        <Stack sx={{ width: 1 }}>
                          ...
                          <Typography sx={{ color: 'secondary.main' }}>{values?.customerInfo?.address}</Typography>
                          <Typography sx={{ color: 'secondary.main' }}>{values?.customerInfo?.phone}</Typography>
                          <Typography sx={{ color: 'secondary.main' }}>{values?.customerInfo?.email}</Typography>
                        </Stack>
                      </Stack>
                    </Grid>
                    <Grid size={{ xs: 12, sm: 4 }}>
...
export default function EditInvoice({ id }: Props) {
  ...
  const breadcrumbLinks = [{ title: 'home', to: APP_DEFAULT_PATH }, { title: 'invoice', to: '/apps/invoice/dashboard' }, { title: 'edit' }];
