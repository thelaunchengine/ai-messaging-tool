...
function getColorStyle({ variant, color, theme }: ButtonStyleProps) {
  ...
  switch (variant) {
    case 'contained':
      return {
        backgroundColor: '#6200ff', // New button background color
        color: '#FFFFFF',
        boxShadow: '0 4px 12px rgba(98, 0, 255, 0.3)',
        '&:hover': {
          backgroundColor: '#4a00cc', // Darker purple on hover
          boxShadow: '0 6px 16px rgba(98, 0, 255, 0.4)',
          transform: 'translateY(-1px)'
        },
        '&:active': {
          transform: 'translateY(0)',
          boxShadow: '0 2px 8px rgba(98, 0, 255, 0.3)'
        },
        ...commonShadow
      };
    case 'shadow':
    ...
    case 'outlined':
      return {
        borderColor: '#6200ff', // New button border color
        color: '#6200ff', // New button text color
        borderWidth: '2px',
        '&:hover': {
          color: '#4a00cc',
          backgroundColor: 'rgba(98, 0, 255, 0.05)', // Light purple background
          borderColor: '#4a00cc',
          transform: 'translateY(-1px)',
        ...
        '&:active': {
          transform: 'translateY(0)',
          boxShadow: '0 2px 8px rgba(98, 0, 255, 0.1)'
        },
        ...commonShadow
      };
    case 'dashed':
