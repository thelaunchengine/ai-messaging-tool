...
export async function POST(
  ...
  try {
    ...
    // Trigger backend to stop scraping for this batch
    try {
      ...
      console.error('Failed to stop backend scraping:', error);
      // Don't fail the request if backend call fails
    }

    return NextResponse.json({
      message: `Scraping stopped for batch ${batchNum}`,
