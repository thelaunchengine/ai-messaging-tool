...
// assets
import { CloseCircle, Document } from '@wandersonalwes/iconsax-react';
  ...
  return (
    ...
    >
      {files.map((file, index) => {
        ...
        return (
          <ListItem key={key} sx={{ my: 1, px: 2, py: 0.75, borderRadius: 0.75, border: ' 1px solid', borderColor: 'divider' }}>
