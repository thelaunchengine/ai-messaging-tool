...
// project-imports
import { Location } from '@wandersonalwes/iconsax-react';
          ...
          .then((results: any) => {
            results[0].address_components.filter((locData: any) => {
              ...
              if (locData.types[0] === 'locality' || locData.types[0] === 'postal_town') {
                if (locData.long_name !== undefined) formik.setFieldValue('city', locData.long_name);
                formik.setFieldTouched('city', false, false);
              }

              if (locData.types[0] === 'administrative_area_level_1') {
                if (locData.long_name !== undefined) formik.setFieldValue('county', locData.long_name);
              ...
              if (locData.types[0] === 'postal_code') {
                if (locData.long_name !== undefined) formik.setFieldValue('postCode', locData.long_name);
