#!/usr/bin/env python3
"""
Check status of specific upload ID
"""
import os
import sys
...
try:
    ...
    try:
        ...
        if websites:
            ...
            print(f"  Contact Forms: {contact_success} success, {contact_failed} failed, {contact_pending} pending, {contact_submitting} submitting")
            print()
